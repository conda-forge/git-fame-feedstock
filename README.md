...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/git-fame-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=10057&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/git-fame-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `git-fame` can be installed with:

```
conda install git-fame
```

It is possible to list all of the versions of `git-fame` available on your platform with:
